...
static void on_input_r_click() {
	...
	gchar *currentLayout = output_to_char("setxkbmap -query | grep layout | awk '{print $2}'");
	gint lineNrOfLayout = get_line_number_containing_string(ConfigPathFile, currentLayout);
